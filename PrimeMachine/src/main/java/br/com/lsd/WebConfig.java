...
public class WebConfig extends WebMvcConfigurerAdapter {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		/*
		if(activeProfiles.contains(PrimeMachineApplication.SPRING_PROFILE_DEVELOPMENT)) {
			registry.addResourceHandler("/woopsocial/images/posts/**").addResourceLocations("file:///" + OpSocialBackApplication.UPLOAD_DIR_IMAGES_POSTS + "/");
