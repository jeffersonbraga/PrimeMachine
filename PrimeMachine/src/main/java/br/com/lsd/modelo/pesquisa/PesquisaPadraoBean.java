package br.com.lsd.modelo.pesquisa;

public class PesquisaPadraoBean {

	private Integer cd_campo;
	private String nm_campo;
	private String ds_label;
	private Integer cd_tipocampo;
	...
	public Integer getCd_tipocampo() {
		return cd_tipocampo;
	}
	public void setCd_tipocampo(Integer cd_tipocampo) {
		this.cd_tipocampo = cd_tipocampo;
	}
