...
@Component({
    selector: 'test-create-account',
    templateUrl: './test-create-account.component.html',
    styleUrls: ['./test-create-account.component.css']
})
export class TestCreateAccountComponent implements OnInit, OnDestroy {
    ...
    makeTransaction() {
        ...
        this.accountService.makeTransactionCielo(this.ipagdto, this.planType)
        .subscribe(
    ...
    onMakeTransaction(res) {
        //EXIBIR RESULTADO OK AO USUÁRIO:::::::::::
        console.log("EXIBIR RESULTADO OK AO USUÁRIO:::::::::::");
        console.log(res);        
        //window.open('https://app.woopsocial.com/home/stream', '_self'); // this.generalService.environment.contexto_aplicacao +
    }

    onMakeTransactionError(error: any) {
        console.log("EXIBIR RESULTADO ERROR AO USUÁRIO:::::::::::");
        console.log(error);
    ...
    obterNome(num) {
        ...
        if(this.validarNumero('Dinners', num))return('Dinners');
