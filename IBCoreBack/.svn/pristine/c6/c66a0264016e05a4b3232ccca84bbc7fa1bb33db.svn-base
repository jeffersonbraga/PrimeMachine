...
public class TwitterMentionFeedsAction extends ServerAction {
	...
	@Override
	@RequestMapping(value = "/twitter_mention_feeds",
	...
	public void doAction() throws Exception {
		...
		if(twitterPaging != null) {
			...
			twitterPosts = getTwitterPosts(twitter.getMentionsTimeline(pagingTwitterFeed),profileDTO.getNetworkId());
	...
	private Paging getTwitterPaging(TwitterPaging pagingDTO) {

		Paging paging = new Paging();
		paging.setCount(pagingDTO.getCount());
		paging.setPage(pagingDTO.getPage());
		paging.setMaxId(pagingDTO.getMaxId());
