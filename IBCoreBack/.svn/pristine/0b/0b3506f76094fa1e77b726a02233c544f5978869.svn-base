    ...
    public Feed readFeed() throws IOException {
        ...
        try {
            ...
            try {
            	...
            	ProxyRegion proxyRegion = UtilFunctions.getProxyRegion(SecurityUtils.getCurrentUser().getAccount().getCountry(), ProxyRegion.ONE_MINUTE);
            	
				InstagramProxyClient instagramProxyClient = new InstagramProxyClient(null, proxyRegion, UtilFunctions.getResidentialPort(proxyRegion));
