...
public class DeactivateLetterToClientsWindowAction extends ServerAction {

	@Override
	@RequestMapping(value = "/deactivate_letter",
	...
	public void doAction() throws Exception, OptimisticLockException {
		...
		user.setShowLettersToClientsWindow(Profile.INACTIVE);
