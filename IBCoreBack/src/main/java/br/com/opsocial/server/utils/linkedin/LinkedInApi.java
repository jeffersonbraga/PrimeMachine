...
//			} 
			...
			if(post.getAppendType() != null) {
				...
				if(post.getAppendType().equals(Post.APPEND_PICTURE)) {
					...
					obj2.put("submitted-url", OpSocialBackApplication.IMAGES_POSTS_PATH + post.getPostsAttachments().get(0).getFileName());
					obj2.put("submitted-image-url", OpSocialBackApplication.IMAGES_POSTS_PATH + post.getPostsAttachments().get(0).getFileName());
					...
					obj2.put("submitted-url", OpSocialBackApplication.VIDEOS_POSTS_PATH + post.getPostsAttachments().get(0).getFileName());
					obj2.put("submitted-image-url", OpSocialBackApplication.VIDEOS_POSTS_PATH + post.getPostsAttachments().get(0).getFileName());
					obj.put("visibility", obj1);
					obj.put("comment", post.getText());
					obj.put("content", obj2);
				}
