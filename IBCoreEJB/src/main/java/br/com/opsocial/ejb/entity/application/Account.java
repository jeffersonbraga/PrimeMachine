...
public class Account extends Persistent {
	...
	// Free = Freemium in the new version
	public static final Byte FREEMIUM = 0; // até 4 perfis - apenas 1 de cada rede 
	...
	public static final Byte WOOP_BASIC = 8; // até 10
	public static final Byte WOOP_INTERMEDIATE = 9; // até 20
	public static final Byte WOOP_ADVANCED	= 10; // até 30
    ...
    //TODO só irá ser usado no OpSocial
//    @Column(name = "state")
//    private String state;
    ...
    @Column(name="paymentAttempt")
	private Integer paymentAttempt;
    
    @Column(name = "subscribeemails")
    private Boolean subscribeEmails = true;
...
//	}
	...
	public Long getFirstProfileDate() {
		return firstProfileDate;
	}

	public void setFirstProfileDate(Long firstProfileDate) {
		this.firstProfileDate = firstProfileDate;
	}
	...
	public Boolean getSubscribeEmails() {
