...
public class PageFansGenderAge {
	...
	private Integer undEighteenAmongTwentyFour = 0;
	private Integer undTwentyFiveAmongThirtyFour = 0;
	...
	public Integer sumThirteenAmongSeventeen() {
		return femaleThirteenAmongSeventeen + maleThirteenAmongSeventeen;
	}
	
	public Integer sumEighteenAmongTwentyFour() {
		return femaleEighteenAmongTwentyFour + maleEighteenAmongTwentyFour;
	}
	
	public Integer sumTwentyFiveAmongThirtyFour() {
		return femaleTwentyFiveAmongThirtyFour + maleTwentyFiveAmongThirtyFour;
	}
	
	public Integer sumThirtyFiveAmongFourtyFour() {
		return femaleThirtyFiveAmongFourtyFour + maleThirtyFiveAmongFourtyFour;
	}
	
	public Integer sumFourtyFiveAmongFiftyFour() {
		return femaleFourtyFiveAmongFiftyFour + maleFourtyFiveAmongFiftyFour;
	}
	
	public Integer sumFiftyFiveAmongSixtyFour() {
		return femaleFiftyFiveAmongSixtyFour + maleFiftyFiveAmongSixtyFour;
	}
	
	public Integer sumSixtyFivePlus() {
		return femaleSixtyFivePlus + maleSixtyFivePlus;
	}
	...
	/**
	 * @return the undEighteenAmongTwentyFour
	 */
	public Integer getUndEighteenAmongTwentyFour() {
		return undEighteenAmongTwentyFour;
	}
	/**
	 * @param undEighteenAmongTwentyFour the undEighteenAmongTwentyFour to set
	 */
	public void setUndEighteenAmongTwentyFour(Integer undEighteenAmongTwentyFour) {
		this.undEighteenAmongTwentyFour = undEighteenAmongTwentyFour;
	}
	/**
	 * @return the undTwentyFiveAmongThirtyFour
	 */
	public Integer getUndTwentyFiveAmongThirtyFour() {
		return undTwentyFiveAmongThirtyFour;
	}
	/**
	 * @param undTwentyFiveAmongThirtyFour the undTwentyFiveAmongThirtyFour to set
	 */
	public void setUndTwentyFiveAmongThirtyFour(Integer undTwentyFiveAmongThirtyFour) {
		this.undTwentyFiveAmongThirtyFour = undTwentyFiveAmongThirtyFour;
	}
}
