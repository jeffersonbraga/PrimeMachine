...
@Entity
@Table(name = "googlepluspostsmonitorings", schema = "opsocial")
@IdClass(GooglePlusPostMonitoringId.class)
public class GooglePlusPostMonitoring extends Persistent {
	...
	public GooglePlusPostMonitoring() {
	}
