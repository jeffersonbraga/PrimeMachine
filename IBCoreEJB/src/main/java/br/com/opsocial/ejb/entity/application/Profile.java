...
public class Profile extends Persistent {
	...
	@Column(name = "instagrambusinessid")
    ...
    @Column(name="authenticationprofilecount")
    private Long authenticationProfileCount = 0L;
	...
	public Long getAuthenticationProfileCount() {
		return authenticationProfileCount;
	}

	public void setAuthenticationProfileCount(Long authenticationProfileCount) {
		this.authenticationProfileCount = authenticationProfileCount;
	}
