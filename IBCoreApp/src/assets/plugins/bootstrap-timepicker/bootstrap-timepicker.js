...
(function($, window, document, undefined) {
  ...
  var Timepicker = function(element, options) {
    ...
    //OPSOCIAL
    this.$element.context.timepikerElement = this;
  ...
  Timepicker.prototype = {
    ...
    decrementGMT: function(step) {
      var newVal;

      if (step) {
        newVal = this.gmt - step;
      } else {
        newVal = this.gmt - this.gmtStep;
      }
    ...
    getTemplate: function() {
      ...
      gmtTemplate = '<input type="text" data-name="gmt" class="bootstrap-timepicker-gmt form-control" maxlength="3"/>';
      ...
      templateContent = '<table>'+
         '<tr>'+
           ...
           : '') +
           '<td class="separator">&nbsp;</td>'+
           '<td><a href="#" data-action="incrementGMT"><i class="glyphicon glyphicon-chevron-up"></i></a></td>' + 
         '</tr>'+
         '<tr>'+
           '<td>'+ hourTemplate +'</td> '+
           '<td class="separator">:</td>'+
         ...
         '<tr>'+
           ...
           : '') +
           '<td class="separator"></td>'+
           '<td><a href="#" data-action="decrementGMT"><i class="glyphicon glyphicon-chevron-down"></i></a></td>' + 
         '</tr>'+
       '</table>';
    ...
    incrementGMT: function(step) {
      var newVal;

      if (step) {
        newVal = this.gmt + step;
      } else {
        newVal = this.gmt + this.gmtStep - (this.gmt % this.gmtStep);
      }
    ...
    updateWidget: function() {
      ...
      if (this.showInputs) {
        ...
        this.$widget.find('input.bootstrap-timepicker-gmt').val(this.gmt);
        ...
        this.$widget.find('span.bootstrap-timepicker-minute').text(minute);
          this.$widget.find('span.bootstrap-timepicker-gmt').text(this.gmt);
