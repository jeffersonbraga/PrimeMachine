package br.com.primum.modelo.acao_preventiva;
...
public class Acao_preventiva implements Serializable {

	/**
	 * 
	 */
	@Transient
	private static final long serialVersionUID = ContextoAplicacao.SERIAL_PADRAO;// 1L;//-2618385056950379129L;
